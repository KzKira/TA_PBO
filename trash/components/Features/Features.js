                            ...
                            <div className="feature-item-wrap">
                                <div className="feature-item">
                                    ...
                                    <div className="feature-text">
                                        <h2><Link onClick={ClickHandler} href="/course">1250+ Courses</Link></h2>
                                ...
                                <div className="feature-item-hidden">
                                    ...
                                    <div className="feature-text">
                                        <h2><Link onClick={ClickHandler} href="/course">1250+ Courses</Link></h2>
                                        <p>We are providing best Courses. That help you be expert.</p>
                                        <Link onClick={ClickHandler} className="more" href="/course">Read More...</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col col-lg-3 col-md-6 col-12">
                            <div className="feature-item-wrap active">
                                <div className="feature-item">
                                    ...
                                    <div className="feature-text">
                                        <h2><Link onClick={ClickHandler} href="/course">25k Students</Link></h2>
                                        <p>We are providing best Courses. That help you be expert. </p>
                                    </div>
                                </div>
                                <div className="feature-item-hidden">
                        ...
                        <div className="col col-lg-3 col-md-6 col-12">
                            <div className="feature-item-wrap">
                                <div className="feature-item">
                                    ...
                                    <div className="feature-text">
                                        <h2><Link onClick={ClickHandler} href="/course">500+ Free class</Link></h2>
                                        <p>We are providing best Courses. That help you be expert. </p>
                                    </div>
                                </div>
                                <div className="feature-item-hidden">
                        ...
                        <div className="col col-lg-3 col-md-6 col-12">
                            <div className="feature-item-wrap">
                                <div className="feature-item">
                                    ...
                                    <div className="feature-text">
                                        <h2><Link onClick={ClickHandler} href="/course">250+ Mentors</Link></h2>
                                        <p>We are providing best Courses. That help you be expert. </p>
                                    </div>
                                </div>
                                <div className="feature-item-hidden">
