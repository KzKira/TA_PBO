                            ...
                            <div className="col col-lg-4 col-md-6 col-12" key={bl}>
                                <div className="wpo-blog-item">
                                    ...
                                    <div className="wpo-blog-content">
                                        ...
                                        <h2><Link onClick={ClickHandler} href={'/blog-single/[slug]'} as={`/blog-single/${blog.slug}`}>{blog.title}</Link>
                                        </h2>
                                        <Link onClick={ClickHandler} href={'/blog-single/[slug]'} as={`/blog-single/${blog.slug}`} className="more">Continue Reading</Link>
                                    </div>
                                </div>
                            </div>
                        ))}
