...
import shape4 from '/public/images/slider/shape-4.svg'
                    ...
                    <div className="container-fluid">
                        <div className="hero-content">
                            ...
                            <div className="student-pic">
                                <Image src={hero1} alt="" />
                                <div className="wp-shape-1"><Image src={shape1} alt="" /></div>
                                <div className="wp-shape-2"><Image src={shape2} alt="" /></div>
                                <div className="wp-shape-3"><Image src={shape3} alt="" /></div>
                                <div className="wp-shape-4"><Image src={shape4} alt="" /></div>
                            </div>
                        </div>
                    </div>
                </div>
