...
import cImag from '/public/images/testimonial/shape-1.png'
import cImag2 from '/public/images/testimonial/shape-2.png'
...
const EventSection = (props) => {
    return (
        <div className="wpo-event-area section-padding">
                            ...
                            <div className="col col-lg-4 col-md-6 col-12" key={evt}>
                                <div className="wpo-event-item">
                                    ...
                                    <div className="wpo-event-content">
                                        ...
                                        <Link onClick={ClickHandler} href={'/event-single/[slug]'} as={`/event-single/${event.slug}`} className="more">Book A Seat</Link>
                                    </div>
                                </div>
                            </div>
                        ))}
            ...
            <div className="shape-1"><Image src={cImag} alt=""/></div>
            <div className="shape-2"><Image src={cImag2} alt=""/></div>
        </div>
    );
}
